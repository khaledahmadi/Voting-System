...
<div id="slider">
	...
	<?php
	 require('dbcon.php');
		$query_position = mysql_query("SELECT DISTINCT position FROM cbaa ")or die(mysql_error());
		...
		?>
			...
			<a href="#" class='close' title='close' name='<?php echo str_replace(' ','',$position); ?>' >x</a>	
			  <?php
			   ...
			   $query_positions = mysql_query("Select * from cbaa where position='$position'")or die(mysql_error());
