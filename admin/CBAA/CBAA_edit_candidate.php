...
renderForm($candidateID,$studnum,$fname,$lname, $gender,$course, $yearlvl, $position, $partylist, $image, $error);
 ...
 mysql_query("UPDATE cbaa SET studnum='$studnum', fname='$fname', lname='$lname',  gender='$gender',course='$course',  yearlvl='$yearlvl',  position='$position',partylist='$partylist',image='$image' WHERE candidateID='$candidateID'")
 or die(mysql_error()); 
 ...
 $result = mysql_query("SELECT * FROM cbaa WHERE candidateID=$candidateID")
 or die(mysql_error()); 
