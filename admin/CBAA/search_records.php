...
<?php
	...
	if($searchword!=""){
		$result=mysql_query("SELECT studnum,fname,lname,course,yearlevel,username,password,datee from vcbaa WHERE studnum LIKE '%".$searchword."%' or lname LIKE '%".$searchword."%' ") or die(mysql_error());
