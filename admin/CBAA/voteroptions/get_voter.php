...
$query = "SELECT * FROM vcbaa where yearlevel = '5th year'";
...
echo "<form method='post' action='delete.php' onSubmit='return confirm(\"Are you sure you want to selected voter?\")'>"; 
//TINANGGAL YUNG DELETE ALL KASI HINDI MARECORD 
...
if(mysql_num_rows($result) == 0) {
			echo "<script> alert('No 5th year Students Records Found');</script>";
}
		else {
