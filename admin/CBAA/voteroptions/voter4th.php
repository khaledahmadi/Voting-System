...
$query = "SELECT * FROM vcbaa where yearlevel = '4th year'";
...
$result = mysql_query($query) or die(mysql_error());
 ...
 echo "<form method='post' action='delete4th.php' onSubmit='return confirm(`Are you sure you want to delete all 4th year voter?`)'>"; 
