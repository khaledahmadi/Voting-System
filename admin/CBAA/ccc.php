...
/* 
        VIEW.PHP
        Displays all data from 'cbaa' table
*/
		...
		$name = mysql_query("SELECT * from cbaa")  or die(mysql_error()); 
        ...
        $result = mysql_query("SELECT b.candidateID,  fname,
							lname, yearlvl , course,  partylist, votes, position
								FROM cbaa b left join res_cbaa r on b.candidateID = r.candidateID order by b.candidateID")or die(mysql_error()); 
       ...
       */
        ...
        echo "<div class='designtable'>";
         echo "<table>";
        echo "<tr><td>Candidate Name</td>	<td>Course</td>	<td>Year</td> <td>Position</td> <td>Party List</td> <td>Votes</td></tr>";
