<html>
<p align = 'center'><font size = '20'>All 2nd Year Students</font></p>
<?php
include('dbcon.php');

$order = mysql_query("SELECT * FROM vbussc WHERE yearlevel = '2nd year'")or die(mysql_error()); 
...
if(mysql_num_rows($order) == 0) {
			echo "<script> alert('No 2nd year Students Records');</script>";
		}
		else {
