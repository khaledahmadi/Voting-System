<html>
<p align = 'center'><font size = '20'>All 4th Year Students</font></p>
<?php
include('dbcon.php');

$order = mysql_query("SELECT * FROM vbussc WHERE yearlevel = '4th year'")or die(mysql_error()); 
...
if(mysql_num_rows($order) == 0) {
			echo "<script> alert('No 4th year Students Records');</script>";
		}
		else {
