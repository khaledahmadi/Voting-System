<?php
	...
	if($_POST['delete']) // from button name="delete"
	{
		...
		for($i=0;$i<$countCheck;$i++)
		{
			...
			$del_id  = $checkbox[$i];
			$studnum = mysql_query("SELECT studnum, fname, lname, course, yearlevel, username, password, datee  FROM vcas where stud_id = $del_id") or die(mysql_error());
