...
$query = "SELECT * FROM vcas where yearlevel = '3rd year'";
...
echo"<br>";
 echo "<form method='post' action='update3rd.php' onSubmit='return confirm(\"Are you sure you want to update selected 3rd year voter?\")'>"; 
