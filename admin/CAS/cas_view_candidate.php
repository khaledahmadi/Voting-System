...
/* 
        VIEW.PHP
        Displays all data from cas table
*/
...
echo"<center>";
         ...
         echo "<table>";
        echo "<tr><td>Student Number</td>	<td>First Name</td> <td>Last Name</td> <td>Gender</td> <td>Course</td> <td>Year</td> <td>Position</td> <td>Partylist</td> <td>Image</td></tr>";

        // loop tdrough results of database query, displaying them in the table
