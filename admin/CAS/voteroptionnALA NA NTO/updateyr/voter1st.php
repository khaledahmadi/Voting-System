<html>
      <link href="../../casadmin.css" rel="stylesheet" type="text/css">  <?php


require 'dbcon.php'; 

$query = "SELECT * FROM vcas where yearlevel = '1st year'";
...
$result = mysql_query($query) or die(mysql_error());
 ...
 echo "<form method='post' action='update1st.php' onSubmit='return confirm(\"Are you sure you want to update selected 1st year voter?\")'>"; 
