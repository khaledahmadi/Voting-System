...
<font face="Century Gothic"><h1>Voter list</h1></font>
<br>
</center>
...
<form action = "voteroptions/5thyr.php" method = "post" target = "_self">
<th><input type = "submit" value = "5th year"></form></th>

<form action = "voteroptions/4thyr.php" method = "post" target = "_self">
...
*/
        ...
        $result = mysql_query("SELECT * FROM vcede") 
                or die(mysql_error());  
