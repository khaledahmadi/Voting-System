...
renderForm($dateid,$datestart,$dateend, $error);
 ...
 mysql_query("UPDATE date SET datestart='$datestart',dateend='$dateend'  WHERE dateid='$dateid' and org = 'cede'")
 or die(mysql_error()); 
 ...
 // query db
 $dateid = $_GET['dateid'];
 $result = mysql_query("SELECT * FROM date WHERE dateid='$dateid' and org = 'cede'")
 or die(mysql_error()); 
